...
for idx, chunk in enumerate(chunks):
        ...
        messages=[
            {
                ...
                'content': 
                f'''
                你是花嫁丽舍的客服分析员，你现在要仔细研究邀约客服的微信聊天记录，也有一些宝宝宴跟一些内部对话，也要分析。全国一共7家分店。你要做的，是仔细查看每条对话客户反感的点，这个点可能是对服务的不满，或者是对客服话术的不满，或者其他不满，并给出案例。要尽量详细，案例越多越好，禁止杜撰。
                请严格按照以下json格式：
                案例：“”（解释一下背景情况）
                客户反感的点：“”
                聊天记录截取：“”
    ...
    file_path = f'./model_output/反感prompt8_{idx+1}.md'
