...
content=list()
for i in range(1,9):
    with open(f'./model_output/反感prompt8_{i}.json','r', encoding='utf-8') as f:
        data = json.load(f)
        content.append(data)
...
with open(f'./model_output/反感integrated.json', 'w', encoding='utf-8') as f:
    f.write(output)
